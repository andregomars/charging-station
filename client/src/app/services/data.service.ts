...
export class DataService {
  ...
  getkWhToday(): Observable<any> {
    this.preApiCall();
    return this.http
      .get<any>(`${this.rootUrl}/kwh-today.json`)
      .pipe(this.AfterApiCallOps);
  }

  getCurrentToday(): Observable<any> {
    this.preApiCall();
    return this.http
      .get<any>(`${this.rootUrl}/current-today.json`)
      .pipe(this.AfterApiCallOps);
  }
  ...
  getAlertTimes2week(): Observable<any> {
    this.preApiCall();
    return this.http
      .get<any>(`${this.rootUrl}/alert-times-2week.json`)
      .pipe(this.AfterApiCallOps);
  }
